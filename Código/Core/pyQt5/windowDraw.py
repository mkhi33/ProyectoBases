...
"")
        ...
        self.tablOptDraw.setSelectionMode(QtWidgets.QAbstractItemView.SingleSelection)
        self.tablOptDraw.setSelectionBehavior(QtWidgets.QAbstractItemView.SelectRows)
        self.tablOptDraw.setRowCount(10)
        self.tablOptDraw.setColumnCount(5)
        ...
        item = QtWidgets.QTableWidgetItem()
        self.tablOptDraw.setHorizontalHeaderItem(4, item)
...
"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        item = self.tablOptDraw.horizontalHeaderItem(4)
