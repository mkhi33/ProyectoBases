...
"color: white;")
        ...
        self.label_2.setGeometry(QtCore.QRect(0, 40, 941, 31))
...
"color:white;")
        ...
        self.tblBitacora.setGeometry(QtCore.QRect(0, 70, 941, 351))
        self.tblBitacora.setRowCount(10)
        self.tblBitacora.setColumnCount(8)
        ...
        item = QtWidgets.QTableWidgetItem()
        self.tblBitacora.setHorizontalHeaderItem(6, item)
        item = QtWidgets.QTableWidgetItem()
        self.tblBitacora.setHorizontalHeaderItem(7, item)
    ...
    def retranslateUi(self, MainWindow):
        ...
        item.setText(_translate("MainWindow", "Autenticación"))
        ...
        item.setText(_translate("MainWindow", "visualización"))
        ...
        item.setText(_translate("MainWindow", "Modificación"))
        item = self.tblBitacora.horizontalHeaderItem(5)
        item.setText(_translate("MainWindow", "Eliminación"))
        item = self.tblBitacora.horizontalHeaderItem(6)
        item.setText(_translate("MainWindow", "configuraciones"))
        item = self.tblBitacora.horizontalHeaderItem(7)
        item.setText(_translate("MainWindow", "usuarios"))
